module.exports = (cat) =>html`<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <main>
        <form action="#" method="" class="cat-form" enctype="multipart/form-data">
            ...
            <button @click = ${req} >Edit Cat</button>
        </form>
    </main>
</body>
...
//     const breed = document.querySelector('#group').value;
//     // const image = document.querySelector('#image').files[0];


//     await fetch(`http://localhost:3000/cats/${catId}/edit`, {
//         method: 'PUT',
//         body: {
//             name,
//             description,
